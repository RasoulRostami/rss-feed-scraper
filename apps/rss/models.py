...
class RSSFeed(BaseModel):
    ...
    image = models.ImageField(null=True, blank=True, help_text="Image of the feed")
    ...
    next_checked = models.DateTimeField(blank=True, null=True, help_text="Next time we need to update posts of feed")
...
class Entry(BaseModel):
    ...
    title = models.CharField(max_length=150, help_text="Title of the feed")
    url = models.TextField(validators=[URLValidator()], help_text="URL for the HTML for this entry", )
